...
class NEURAL_NETWORK: 
    ...
    def Update(self):
        for nkey in self.neurons.keys():
            if self.neurons[nkey].Is_Sensor_Neuron():
                self.neurons[nkey].Update_Sensor_Neuron()
            else:
                self.neurons[nkey].Update_Hidden_Or_Motor_Neuron(self.neurons, self.synapses)
