...
class NEURON: 
    ...
    def Update_Hidden_Or_Motor_Neuron(self, neurons, synapses):
        ...
        for skey in synapses.keys():
            if self.Get_Name() == skey[1]:
                self.Allow_Presynaptic_Neuron_To_Influence_Me(neurons[skey[0]].Get_Value(), synapses[skey].Get_Weight())

        self.Threshold()

    def Allow_Presynaptic_Neuron_To_Influence_Me(self, val, weight):
        self.Add_To_Value(val * weight)
